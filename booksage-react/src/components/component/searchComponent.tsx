...
export function SearchComponent({query, setQuery, handleSearch, handleKeyDown, history, setHistory}: searchComponentProps) {
    ...
    return (<div className="flex items-center gap-2">
        ...
        <Input
            className="rounded-md border border-gray-200 dark:border-gray-800 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-500 dark:focus:ring-gray-400 dark:bg-gray-900 dark:text-gray-100"
            placeholder="Search..."
            type="search"
            value={query}
